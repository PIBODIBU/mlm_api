      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "signature",
            "description": "<p>MD5 signature - dialog_id/recipient_uuid, secret.</p>"
          }
        ],
        "Switchable parameters (one must be filled)": [
          {
            "group": "Switchable parameters (one must be filled)",
            "type": "String",
            "optional": false,
            "field": "dialog_id",
          ...
          },
          {
            ...
            "description": "<p>User to send message.</p>"
          }
        ]
      }
    },
